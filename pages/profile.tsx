...
const Profile = () => {
    ...
    return (
        <Layout pageOptions={pageOptions}>
            ...
            {isFetching ? (
                <>
                    <h1 className="flex items-center justify-center flex-1 h-full text-3xl text-white/50">
                        <div role="status">
                            <svg
                ...
                questions && (
                    <div className="flex flex-col flex-1 md:flex-row md:space-x-10 space-y-7 md:space-y-0">
